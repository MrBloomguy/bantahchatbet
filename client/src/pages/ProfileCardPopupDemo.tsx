...
const ProfileCardPopupDemo: React.FC = () => {
  const { currentUser } = useAuth();
  const [showProfileCard, setShowProfileCard] = useState(false);

  // Log when the profile card is shown or hidden
  useEffect(() => {
    console.log('Profile card state changed:', showProfileCard ? 'SHOWN' : 'HIDDEN');
  }, [showProfileCard]);
            ...
            <div className="flex justify-center">
              <button
                ...
                onClick={(e) => {
                  ...
                  console.log('Avatar clicked, showing profile card');
...
export default ProfileCardPopupDemo;
