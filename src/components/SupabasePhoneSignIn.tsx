...
const SupabasePhoneSignIn: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const handlePhoneSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(`Attempting to sign in with phone: ${formattedPhoneNumber}`);
      
      // In a real implementation, we would send an OTP via SMS here
      // For now, we'll just simulate it for development purposes
      
      // Move to OTP screen
      setStep('otp');
      toast.showSuccess('Verification code sent! Check your phone.');
      
      // In development mode, we'll just simulate a successful OTP send
      console.log('Development mode: Proceeding to OTP screen');
    } catch (error: any) {
  ...
  const handleOtpSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      // For development purposes, let's simulate a successful sign-in
      // In production, you would implement proper phone authentication
      
      // Simulate signing in with email (as a workaround)
  ...
  const handleResendCode = async () => {
    ...
    try {
      // In a real implementation, we would resend the OTP here
...
export default SupabasePhoneSignIn;
