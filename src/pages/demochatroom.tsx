...
import { useMessages, ChatRoomProvider } from '@ably/chat/react';
...
export function DemoChatRoom() {
  if (!ABLY_API_KEY) {
    return (
      <div style={{ color: 'red', textAlign: 'center', margin: '20px' }}>
        Ably API key is missing. Set <code>VITE_ABLY_API_KEY</code> in your environment to enable chat.
      </div>
    );
  }
  return (
    <ChatRoomProvider name="demochatroom">
      <Messages />
    </ChatRoomProvider>
  );
}
